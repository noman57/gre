...
public class PersonController {
    ...
    @GetMapping
    public HttpEntity<Page<Person>> getPersonPage(final Pageable pageable) {
    ...
    @PostMapping
    public ResponseEntity<String> createPerson(@Valid @RequestBody PersonDTO personDTO, final UriComponentsBuilder ucBuilder)  {
